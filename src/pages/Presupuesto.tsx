        ...
        <div className="quote-form">
            ...
            <div className="form-services">
              {SERVICES.map(svc => (
                <label key={svc.id} className="service-label">
                  <input
                    type="checkbox"
                    checked={!!checkedServices[svc.id]}
          ...
          <div className="form-section">
            ...
            <div style={{
              ...
              outline: '4px solid rgba(232,82,26,0.10)',
              outlineOffset: '3px',
              overflow: 'hidden',
              lineHeight: 0,
            }}>
        ...
        <div className="quote-summary">
          ...
          <div className="summary-row">
            ...
            <span className="value orange">
              {qty.toLocaleString('es-AR')} {qty === 1 ? 'unidad' : 'unidades'}
            </span>
          </div>
          <div className="summary-row">
          ...
          {SERVICES.map(svc => checkedServices[svc.id] && (
            <div key={svc.id} className="summary-row">
              ...
              <span className="value">
                {fmt(svc.type === 'unit' ? qty * svc.price : svc.price)}
              </span>
            </div>
          ))}

          <div
            className={`summary-cash-option${cashDiscount ? ' active' : ''}`}
            onClick={() => setCashDiscount(d => !d)}
          >
